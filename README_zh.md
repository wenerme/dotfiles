...
<!-- source(.bashrc.d/rc_after.sh:16) -->
## rc_after
* 检测 Homebrew 环境
  * 添加 bin 目录
  * 添加无前缀的 coreutils
...
<!-- source(.bashrc.d/rc_after.sh:79) -->
...
<!-- source(.bashrc.d/rc_after.sh:121) -->
...
<!-- source(.bashrc.d/rc_after.sh:221) -->
* sshrc
  * 在 sshrc 下做一些后续处理
  * 为 `~/.inputrc` 设置符号链接
  * 为 `~/.gitconfig` 设置符号链接

<!-- source(.bashrc.d/rc_alias.sh:29) -->
## rc_alias
* cd
	* `..`,`...`,`....`,`.....`,`~`,`-`
	* `cd-`,`cd..`,`cd...`
